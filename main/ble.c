        ...
        case HCI_EVENT_PACKET:
            switch (hci_event_packet_get_type(packet)) {
                ...
                case ATT_EVENT_CAN_SEND_NOW:
                    att_server_notify(
                      con_handle,
                      ATT_CHARACTERISTIC_93E9A984_40CD_4B57_A31A_3D3857D80A09_01_VALUE_HANDLE,
                      (uint8_t*)&app_state->current_channel, sizeof(int)
                      );
                    att_server_notify(
                      con_handle,
                      ATT_CHARACTERISTIC_FBD47252_6210_4692_A247_1DB3007CF668_01_VALUE_HANDLE,
...
static uint16_t att_read_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t offset, uint8_t * buffer, uint16_t buffer_size){
    ...
    if (att_handle == ATT_CHARACTERISTIC_FBD47252_6210_4692_A247_1DB3007CF668_01_VALUE_HANDLE){
